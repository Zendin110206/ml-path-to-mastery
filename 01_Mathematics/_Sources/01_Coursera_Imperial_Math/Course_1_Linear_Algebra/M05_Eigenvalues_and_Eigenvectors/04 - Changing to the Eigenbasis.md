...
We now know how to "translate" our transformation `T` into the eigenbasis world. This uses the [[03 - Transformations in a Changed Basis|change of basis formula]] we've already learned (`A⁻¹MA`).
