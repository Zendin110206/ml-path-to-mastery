...
3.  Solve this system of linear equations to find the vector $\vec{x}$ (or set of vectors) that is the solution. This is the **[[Ch 07 - Inverse Matrices, Column Space and Null Space#4. Null Space (Kernel) - "Pasukan yang Lenyap ke Titik Nol"|Null Space]]** of the matrix $A - \lambda I$.
